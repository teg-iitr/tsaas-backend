...
class TableWillingnessSurveyDetails(models.Model):
    surveyID = models.ForeignKey(SurveyList, blank=True, null=True,
                                 on_delete=models.CASCADE, related_name='TableWillingnessSurveyDetails', verbose_name='Survey ID')
    collegeID = models.ForeignKey(CollegeList, blank=True, null=True,
                                  on_delete=models.CASCADE, related_name='TableWillingnessSurveyDetails', verbose_name='College ID')
...
# OPTION 4 CHOICE SET B
    ...
    SubmitTime = models.CharField(
        max_length=100, null=True, blank=True, verbose_name='SubmitTime')
    # page first#
    Startime = models.CharField(
        max_length=100, null=True, blank=True, verbose_name='Startime')
    CollegeName = models.CharField(
        max_length=100, null=True, blank=True, verbose_name='CollegeName')
    Collegeurl = models.CharField(
        max_length=100, null=True, blank=True, verbose_name='Collegeurl')
    SurveyId = models.CharField(
        max_length=100, null=True, blank=True, verbose_name='SurveyId')
