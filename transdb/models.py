...
class AQIPerceptionSurvey(models.Model):
	...
	impactOnPrimaryActs = models.CharField(max_length=100, null=True, blank=True, verbose_name='Impact on travel choices for primary activities')
	impactOnSecondaryActs = models.CharField(max_length=100, null=True, blank=True, verbose_name='Impact on travel choices for secondary activities')
	primaryActTripPreference = models.CharField(max_length=100, null=True, blank=True, verbose_name='Primary activity trip preferences')
	secondaryActTripPreference = models.CharField(max_length=100, null=True, blank=True, verbose_name='Secondary activity trip preferences')
	reasonNotToChangeChoices = models.CharField(max_length=500, null=True, blank=True, verbose_name='Reason for not changing the travel choice due to poor AQ')
	# Part E
	...
	primaryActTripPreferenceAQIAPI = models.CharField(max_length=100, null=True, blank=True, verbose_name='Primary activity trip preferences for AQI API')
	secondaryActTripPreferenceAQIAPI = models.CharField(max_length=100, null=True, blank=True, verbose_name='Secondary activity trip preferences  for AQI API')
	primaryModeAQIAPI = models.CharField(max_length=200, null=True, blank=True, verbose_name='Primary activity travel mode  for AQI API')
	secondaryModeAQIAPI = models.CharField(max_length=200, null=True, blank=True, verbose_name='Secondary activity travel mode for AQI API')
	# Part C
	...
	healthEffect = models.CharField(max_length=600, null=True, blank=True, verbose_name='Impact on health')
	...
	sensitiveGroupEffect = models.CharField(max_length=100, null=True, blank=True, verbose_name='Impact of poor AQI on sensitive age-groups')
